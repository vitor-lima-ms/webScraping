...
def noticiasPremeierLeague(request):
    BASE_URL = 'https://www.cnnbrasil.com.br/tudo-sobre/premier-league/'
...
def premierLeague(request):
    BASE_URL = 'https://www.cnnbrasil.com.br/esportes/futebol/tabela-premier-league/'
    response = requests.get(BASE_URL)
